...
public class InventoryUtils extends Utils{
    ...
    public static void sellInventory() {
        try {
            // Sell to NPC
            addCustomChat("Selling inventory");
            ...
            for (int j = 0; j < 36; j++) {
                ...
                if (sellStack != null) {
                    ...
                    if (name.contains("Carrot") && !name.contains("Hoe")) {
                        addCustomChat("Found carrots, selling");
    ...
    public static int countSack(int slotID) {
        ...
        for (int j = 0; j < list.tagCount(); j++) {
            ...
            if (matcher.matches()) {
                addCustomChat("Stored: " + matcher.group(2));
    ...
    public static int getCounter() {
        ...
        addCustomChat("Error: Cannot find counter on held item");
        return 0;
    }
